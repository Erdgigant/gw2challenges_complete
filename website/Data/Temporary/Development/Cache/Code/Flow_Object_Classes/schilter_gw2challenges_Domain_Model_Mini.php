 ...
 */
class Mini extends Mini_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface, \Neos\Flow\Persistence\Aspect\PersistenceMagicInterface {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['__construct'])) {
            ...
            try {
                ...
                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['__construct']['Neos\Flow\Aop\Advice\BeforeAdvice'])) {
                    ...
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'schilter\gw2challenges\Domain\Model\Mini', '__construct', $methodArguments);
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['__clone'])) {
            ...
            try {
                ...
                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['__clone']['Neos\Flow\Aop\Advice\BeforeAdvice'])) {
                    ...
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'schilter\gw2challenges\Domain\Model\Mini', '__clone', $methodArguments);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
                ...
                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['__clone']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    ...
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'schilter\gw2challenges\Domain\Model\Mini', '__clone', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
...
# PathAndFilename: /var/www/php/Packages/Application/schilter.gw2challenges/Classes/Domain/Model/Mini.php
#