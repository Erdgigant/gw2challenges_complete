<?php 
class layout_Default_68f3e145d5f873cc011535f9ec8fe75b495ef719 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= Neos\FluidAdaptor\ViewHelpers\BaseViewHelper::renderStatic($arguments3, $renderChildrenClosure4, $renderingContext);
...
$arguments5['class'] = 'flashmessages';

$output0 .= Neos\FluidAdaptor\ViewHelpers\FlashMessagesViewHelper::renderStatic($arguments5, $renderChildrenClosure6, $renderingContext);
