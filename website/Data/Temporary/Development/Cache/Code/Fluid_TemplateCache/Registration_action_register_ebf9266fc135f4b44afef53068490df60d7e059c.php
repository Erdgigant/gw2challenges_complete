...
$output0 .= '
  <div class="callout success">
    <p>Wir haben eine E-Mail zur Bestätigung der Registrierung an <strong>';
$array1 = array (
);
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('registrationFlow.email', $array1), ENT_QUOTES);

$output0 .= '</strong> gesendet. Bitte folgen Sie der Anleitung in der E-Mail, um die Registrierung zu bestätigen.</p>
  </div>
';
...
$output9 .= '</strong> gesendet. Bitte folgen Sie der Anleitung in der E-Mail, um die Registrierung zu bestätigen.</p>
  </div>
';
return $output9;
};
