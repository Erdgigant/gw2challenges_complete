<?php 
class User_action_api_79cc81e1857da58b38346f510b0338f086459728 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments4['name'] = 'api';
$array6 = array (
);$arguments4['value'] = $renderingContext->getVariableProvider()->getByPath('api', $array6);
...
$arguments16['name'] = 'api';
$array18 = array (
);$arguments16['value'] = $renderingContext->getVariableProvider()->getByPath('api', $array18);

$output15 .= Neos\FluidAdaptor\ViewHelpers\Form\TextfieldViewHelper::renderStatic($arguments16, $renderChildrenClosure17, $renderingContext);
...
$arguments13['action'] = 'edit';

$output12 .= Neos\FluidAdaptor\ViewHelpers\FormViewHelper::renderStatic($arguments13, $renderChildrenClosure14, $renderingContext);
