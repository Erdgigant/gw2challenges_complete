<?php 
class _action__fe039e0111b108481d031c6b1e075a2a98929439 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('statusCode', $array1), ENT_QUOTES);

$output0 .= ' - ';
$array2 = array (
);
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('statusMessage', $array2), ENT_QUOTES);
...
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('statusCode', $array3), ENT_QUOTES);

$output0 .= ' - ';
$array4 = array (
);
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('statusMessage', $array4), ENT_QUOTES);
...
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('errorDescription', $array5), ENT_QUOTES);
...
$output11 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('exception.message', $array12), ENT_QUOTES);
...
$output18 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('exception.referenceCode', $array19), ENT_QUOTES);
...
$array15 = array();
$array16 = array (
);$array15['0'] = $renderingContext->getVariableProvider()->getByPath('exception.referenceCode', $array16);
...
$array8 = array();
$array9 = array (
);$array8['0'] = $renderingContext->getVariableProvider()->getByPath('renderingOptions.renderTechnicalDetails', $array9);
